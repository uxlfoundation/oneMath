...
void gemm_batch(sycl::queue&, transpose transa, transpose transb, int64_t m, int64_t n,
...
void gemm_batch(sycl::queue&, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    for (int64_t i = 0; i < batch_size; ++i) {
        ...
        cblas_cgemm(order, tA, tB,
                    (blasint)m, (blasint)n, (blasint)k,
                    static_cast<const void*>(&alpha),
                    static_cast<const void*>(A), (blasint)lda,
                    static_cast<const void*>(B), (blasint)ldb,
