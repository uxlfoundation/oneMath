...
class CountAdaptorMcg31UniformStdDeviceMomentsTests : public ::testing::TestWithParam<sycl::device*> {};

class CountAdaptorMcg59BitsStdDeviceMomentsTests : public ::testing::TestWithParam<sycl::device*> {};

class CountAdaptorPhiloxUniformBitsStdDeviceMomentsTests : public ::testing::TestWithParam<sycl::device*> {};

class CountAdaptorMrg32GaussianStdDeviceMomentsTests : public ::testing::TestWithParam<sycl::device*> {};

TEST_P(CountAdaptorMcg31UniformStdDeviceMomentsTests, RealSinglePrecision) {
    rng_device_test<moments_test<oneapi::math::rng::device::count_engine_adaptor<
                                     oneapi::math::rng::device::mcg31m1<4>>,
                                 oneapi::math::rng::device::uniform<
                                     float, oneapi::math::rng::device::uniform_method::standard>>>
        test1;
    EXPECT_TRUEORSKIP((test1(GetParam())));
...
TEST_P(CountAdaptorMcg59BitsStdDeviceMomentsTests, UnsignedLongIntegerPrecision) {
    rng_device_test<moments_test<oneapi::math::rng::device::count_engine_adaptor<
                                     oneapi::math::rng::device::mcg59<4>>,
                                 oneapi::math::rng::device::bits<uint64_t>>>
        test1;
    EXPECT_TRUEORSKIP((test1(GetParam())));
}

TEST_P(CountAdaptorPhiloxUniformBitsStdDeviceMomentsTests, UnsignedIntegerPrecision) {
    rng_device_test<moments_test<oneapi::math::rng::device::count_engine_adaptor<
                                     oneapi::math::rng::device::philox4x32x10<4>>,
                                 oneapi::math::rng::device::uniform_bits<uint32_t>>>
        test1;
...
TEST_P(CountAdaptorMrg32GaussianStdDeviceMomentsTests, RealSinglePrecision) {
    rng_device_test<moments_test<oneapi::math::rng::device::count_engine_adaptor<
                                     oneapi::math::rng::device::mrg32k3a<4>>,
                                 oneapi::math::rng::device::gaussian<float>>>
        test1;
    EXPECT_TRUEORSKIP((test1(GetParam())));
}

INSTANTIATE_TEST_SUITE_P(CountAdaptorMcg31UniformStdDeviceMomentsTestsSuite,
                         CountAdaptorMcg31UniformStdDeviceMomentsTests, ::testing::ValuesIn(devices),
                         ::DeviceNamePrint());

INSTANTIATE_TEST_SUITE_P(CountAdaptorMcg59BitsStdDeviceMomentsTestsSuite,
                         CountAdaptorMcg59BitsStdDeviceMomentsTests, ::testing::ValuesIn(devices),
                         ::DeviceNamePrint());

INSTANTIATE_TEST_SUITE_P(CountAdaptorPhiloxUniformBitsStdDeviceMomentsTestsSuite,
                         CountAdaptorPhiloxUniformBitsStdDeviceMomentsTests, ::testing::ValuesIn(devices),
                         ::DeviceNamePrint());

INSTANTIATE_TEST_SUITE_P(CountAdaptorMrg32GaussianStdDeviceMomentsTestsSuite,
                         CountAdaptorMrg32GaussianStdDeviceMomentsTests, ::testing::ValuesIn(devices),
                         ::DeviceNamePrint());
