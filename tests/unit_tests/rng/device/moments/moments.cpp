...
class CountAdaptorMcg31UniformStdDeviceMomentsTests
        : public ::testing::TestWithParam<sycl::device*> {};

class CountAdaptorMcg59BitsStdDeviceMomentsTests : public ::testing::TestWithParam<sycl::device*> {
};

class CountAdaptorPhiloxUniformBitsStdDeviceMomentsTests
        : public ::testing::TestWithParam<sycl::device*> {};

class CountAdaptorMrg32GaussianStdDeviceMomentsTests
        : public ::testing::TestWithParam<sycl::device*> {};

TEST_P(CountAdaptorMcg31UniformStdDeviceMomentsTests, RealSinglePrecision) {
    rng_device_test<moments_test<
        oneapi::math::rng::device::count_engine_adaptor<oneapi::math::rng::device::mcg31m1<4>>,
        oneapi::math::rng::device::uniform<float,
...
TEST_P(CountAdaptorMcg59BitsStdDeviceMomentsTests, UnsignedLongIntegerPrecision) {
    rng_device_test<moments_test<
        oneapi::math::rng::device::count_engine_adaptor<oneapi::math::rng::device::mcg59<4>>,
...
TEST_P(CountAdaptorMrg32GaussianStdDeviceMomentsTests, RealSinglePrecision) {
    rng_device_test<moments_test<
        oneapi::math::rng::device::count_engine_adaptor<oneapi::math::rng::device::mrg32k3a<4>>,
...
INSTANTIATE_TEST_SUITE_P(CountAdaptorMcg31UniformStdDeviceMomentsTestsSuite,
                         CountAdaptorMcg31UniformStdDeviceMomentsTests,
                         ::testing::ValuesIn(devices), ::DeviceNamePrint());
...
INSTANTIATE_TEST_SUITE_P(CountAdaptorPhiloxUniformBitsStdDeviceMomentsTestsSuite,
                         CountAdaptorPhiloxUniformBitsStdDeviceMomentsTests,
                         ::testing::ValuesIn(devices), ::DeviceNamePrint());

INSTANTIATE_TEST_SUITE_P(CountAdaptorMrg32GaussianStdDeviceMomentsTestsSuite,
                         CountAdaptorMrg32GaussianStdDeviceMomentsTests,
                         ::testing::ValuesIn(devices), ::DeviceNamePrint());
